package cc.innosoft.thirdchat.filter;
...
import cc.innosoft.thirdchat.constant.ResultCode;
import cc.innosoft.thirdchat.constant.ResultMsg;
import cc.innosoft.thirdchat.domain.User;
import cc.innosoft.thirdchat.util.JsonUtil;
/**
 * session拦截器
 */
public class SessionFilter implements Filter {
	private static final Logger logger = LoggerFactory.getLogger(SessionFilter.class);
	private String[] whitePathList = {"/user/register", "/user/login"};
